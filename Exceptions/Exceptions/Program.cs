...
class Program
{
    static void Main(string[] args)
    {
        ...
        //  in the list by.Write a loop that takes each integer in the list, 
        ...
        //   emerged from the try/catch block and continued on with program execution.
        ...
        //List<double> num = new List<double>() { 89, 99, 100, 128, 256, 328, 769, 572 };
        //Console.WriteLine("Enter a number: ");
        //int userInput = Convert.ToInt16(Console.ReadLine());
        //for (int i = 0; i < num.Count; i++)
        //{
        //    Console.WriteLine(num[i] / userInput);
        //}
        //    try
        //{
        //    List<double> num = new List<double>() { 89, 99, 100, 128, 256, 328, 769, 572 };
